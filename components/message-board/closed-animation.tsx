...
export function ClosedAnimation({ notice }: { notice: string }) {
  return (
    <GlassCard className="relative overflow-hidden p-7 text-center">
      ...
      <div className="absolute left-1/2 top-1/2 h-56 w-56 -translate-x-1/2 -translate-y-1/2 rounded-full bg-bitcoin/10 blur-[90px]" aria-hidden />
      <div className="relative mx-auto flex h-56 w-56 animate-float items-center justify-center">
        ...
        <div className="relative rounded-3xl border border-bitcoin/50 bg-black/60 p-7 text-bitcoin shadow-orange backdrop-blur-lg">
